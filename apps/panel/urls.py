...
urlpatterns = [
    ...
    path("comunicados/categorias/", views.categorias_comunicado, name="categorias_comunicado"),
    path("comunicados/categorias/<int:pk>/eliminar/", views.categoria_comunicado_delete, name="categoria_comunicado_delete"),
    ...
    path("documentos/categorias/", views.categorias_documento, name="categorias_documento"),
    path("documentos/categorias/<int:pk>/eliminar/", views.categoria_documento_delete, name="categoria_documento_delete"),
    ...
    path("beneficios/categorias/", views.categorias_beneficio, name="categorias_beneficio"),
    path("beneficios/categorias/<int:pk>/eliminar/", views.categoria_beneficio_delete, name="categoria_beneficio_delete"),
